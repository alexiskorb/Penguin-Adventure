	...
	public void keyPressed(KeyEvent e)
	{
		switch(e.getKeyCode())
		{
			...
			case KeyEvent.VK_RIGHT : keys[15]=true;break;
                        ...
                        case KeyEvent.VK_E : keys[17] = true;break;
                        case KeyEvent.VK_R : keys[18] = true;break;
                        case KeyEvent.VK_T : keys[19] = true; break;
                        case KeyEvent.VK_P : keys[20] = true;break;
                        case KeyEvent.VK_Y : keys[21] = true;break;
                        case KeyEvent.VK_K : keys[22] = true;break;
                        case KeyEvent.VK_I : keys[23] = true;break;
                }
	...
	public void keyReleased(KeyEvent e)
	{
		switch(e.getKeyCode())
		{
			...
			case KeyEvent.VK_RIGHT : keys[15]=false;break;
                        ...
                        case KeyEvent.VK_E : keys[17] = false;break;
                        case KeyEvent.VK_R : keys[18] = false;break;
                        case KeyEvent.VK_T : keys[19] = false; break;
                        case KeyEvent.VK_P : keys[20] = false;break;
                        case KeyEvent.VK_Y : keys[21] = false;break;
                        case KeyEvent.VK_K : keys[22] = false;break;
                        case KeyEvent.VK_I : keys[23] = false;break;
		}
	}
